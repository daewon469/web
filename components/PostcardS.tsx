...
export default function PostcardS({ post, showHeart = true, onLikedChange }: Props) {
  ...
  return (
    <div className="relative w-full" style={{ height: LIST_CARD_HEIGHT_TYPE_S }}>
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-[1] border-b border-black bg-white"
        aria-hidden
      >
      ...
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 z-[1] border-t border-black bg-white"
        aria-hidden
      >
        <div className="flex flex-col gap-0 px-2 py-1.5">
